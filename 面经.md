...
- 应聘后端开发工程师 chaoqun 目前是Upen研究生在读
- 项目方面这是一个MIT的实验课, 实现了一个基于Raft算法的KV存储系统, , 我觉得对于提升自己对于理解分布式场景下数据一致性的各种情况的解决有很大帮助
- 语言方面比较熟悉java语言, 看过JDK源码, 了解Java并发, JVM的相关的知识点
- 计算机基础方面 热爱算法, 自己实现过一些数据结构数据结构, 比如堆, AVL树, 红黑树, 熟悉操作系统的进程管理内存管理
- 了解计算机网络, 了解对于OSI模型中各层的协议, 对于工作中使用到的计网知识有一定了解
- 熟悉MySQL索引优化,mvcc Redis的线程模型, 以及分布式场景下缓存穿透, 击穿, 雪崩问题下的解决方法, 
...
- 熟练的掌握 基础知识, 操作系统, 计算机网络, 因为这些对于设计整体的架构的基石
- 了解数据库缓存,框架, 中间件技术的原理, 从而能够在技术选型的时候给出自己的观点
- 对于某一个方向比如分布式需要能够达到精通的程度
- 了解系统架构. 能够站在设计系统的角度来看待公司项目的整体架构, 并且提出一些可以优化的点并且解决
